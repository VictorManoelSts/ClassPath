 ...
 * então o endereço da API entra por aqui. É o que o Dockerfile chama
 * antes do `ng build`, para não precisar editar código para trocar de
 * servidor.
 *
...
console.log(`environments atualizados: apiUrl=${apiUrl} periodo=${periodo}`);
